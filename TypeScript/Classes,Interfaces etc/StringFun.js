...
var Str = string.concat(" SemanticBits"); //concatntin of two strings
...
var sliced = string.slice(3, -2); //slice the string
console.log("  string.slice(3, -2) is  :" + sliced);
var spilt = string.split(" ", 2); //spilt the string by delemiter
...
var student = "SAIKUMAR";
var student1 = student.toLowerCase(); //string convertion to lowercase
